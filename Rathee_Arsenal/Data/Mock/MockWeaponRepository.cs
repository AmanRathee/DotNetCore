    ...
    public class MockWeaponRepository : IWeaponRepository
    {
        ...
        public IEnumerable<Weapon> GetAllWeapons
        {
            get => new List<Weapon>()
                    {
                        new Weapon(){
                                        WeaponId =1,Description="Smith & Wesson 686 Stainless 6 357MAG Revolvr NEW",ImageUrl="/Images/1_Cat1.jpg",Price=100000M,
                                        InStock=5,IsTrending=true,Name="Smith & Wesson 686 Stainless 6 357MAG Revolvr NEW",Category=_categoryRepo.Categories.First()
                                    },
                        new Weapon(){
                                       WeaponId =2,Description="TAURUS MODEL 94 .22LR",ImageUrl="/Images/2_Cat1.jpg",Price=100660M,
                                        InStock=10,IsTrending=false,Name="TAURUS MODEL 94 .22LR",Category=_categoryRepo.Categories.First()
                                    },
                        new Weapon(){
                                       WeaponId =3,Description="COLT 38 DS II - NO CC FEES!",ImageUrl="/Images/3_Cat1.jpg",Price=90000M,
                                        InStock=2,IsTrending=false,Name="COLT 38 DS II - NO CC FEES!",Category=_categoryRepo.Categories.First()

                                    },
                        new Weapon(){
                                        WeaponId =4,Description="Ruger Bearcat .22 LR 1971",ImageUrl="/Images/4_Cat1.jpg",Price=350000M,
                                        InStock=10,IsTrending=true,Name="Ruger Bearcat .22 LR 1971",Category=_categoryRepo.Categories.First()

                                    },
                        new Weapon(){
                                        WeaponId =5,Description="Pointer Phenoma PPHCW2028GRY 20/28 3 Walther 5CT",ImageUrl="/Images/1_Cat2.jpg",Price=600000M,
                                        InStock=50,IsTrending=true,Name="Pointer Phenoma PPHCW2028GRY 20/28 3 Walther 5CT",Category=_categoryRepo.Categories.Last()

                                    },
                        new Weapon(){
                                       WeaponId =6,Description="Remington TAC-14 12GA Wood Remington TAC14 81231",ImageUrl="/Images/2_Cat2.jpg",Price=956320M,
